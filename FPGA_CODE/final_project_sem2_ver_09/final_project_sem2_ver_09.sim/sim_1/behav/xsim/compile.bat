...
REM
REM Generated by Vivado on Mon Apr 06 19:30:45 +0700 2026
...
echo "xvlog --incr --relax -prj pwm_gen_vlog.prj"
call xvlog  --incr --relax -prj pwm_gen_vlog.prj -log xvlog.log
